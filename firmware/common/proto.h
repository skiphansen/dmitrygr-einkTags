...
#define HW_TYPE_74_INCH_DISPDATA_Y				(2)
#define HW_TYPE_74_INCH_DISPDATA_Y_FRAME_MODE	(3)
#define HW_TYPE_74_INCH_DISPDATA_R				(12)
#define HW_TYPE_74_INCH_DISPDATA_R_FRAME_MODE	(13)
