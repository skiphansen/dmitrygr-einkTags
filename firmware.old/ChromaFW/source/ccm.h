...
struct AesCcmInfo {
	...
	const uint8_t nonce[AES_CCM_NONCE_SIZE];
};


void aesCcmEnc(void __xdata *dst, const void __xdata *src, const struct AesCcmInfo __xdata *ccmInfo);
__bit aesCcmDec(void __xdata *dst, const void __xdata *src, const struct AesCcmInfo __xdata *ccmInfo);
