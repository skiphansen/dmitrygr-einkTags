...
bool commsTx(struct CommsInfo *info, bool bcast, const void __xdata *packet, uint8_t len);
int8_t commsRx(struct CommsInfo *info, void __xdata *data, uint8_t __xdata *fromMac);	//returns length or COMMS_RX_ERR_*
